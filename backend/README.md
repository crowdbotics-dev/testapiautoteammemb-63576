...
## Project Structure
    ...
    ├── testapiautoteammemb_63576  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_63576`
...
2. Clone this repo and `cd testapiautoteammemb_63576`
